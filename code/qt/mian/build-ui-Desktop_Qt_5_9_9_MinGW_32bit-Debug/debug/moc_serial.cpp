...
QT_MOC_LITERAL(1, 7, 10), // "Setvoltage"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 3), // "num"
QT_MOC_LITERAL(4, 23, 7), // "recvMsg"
QT_MOC_LITERAL(5, 31, 8) // "getMeter"

    },
    "Serial\0Setvoltage\0\0num\0recvMsg\0getMeter"
};
...
void Serial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Setvoltage((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->recvMsg(); break;
        case 2: _t->getMeter(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Serial::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Serial::Setvoltage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Serial::Setvoltage(int _t1)
{
