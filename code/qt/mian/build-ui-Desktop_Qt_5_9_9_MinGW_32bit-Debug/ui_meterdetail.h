...
public:
    ...
    void setupUi(QMainWindow *MeterDetail)
    {
        ...
        voltage_2 = new QLineEdit(widget_12);
        voltage_2->setObjectName(QStringLiteral("voltage_2"));
        voltage_2->setGeometry(QRect(9, 22, 108, 22));
        current1_2 = new QLineEdit(widget_12);
        current1_2->setObjectName(QStringLiteral("current1_2"));
        current1_2->setGeometry(QRect(9, 63, 108, 22));
        power1_5 = new QLineEdit(widget_12);
        power1_5->setObjectName(QStringLiteral("power1_5"));
        power1_5->setGeometry(QRect(9, 104, 108, 22));
        power1_6 = new QLineEdit(widget_12);
        power1_6->setObjectName(QStringLiteral("power1_6"));
        power1_6->setGeometry(QRect(10, 150, 108, 22));
        power1_7 = new QLineEdit(widget_12);
        power1_7->setObjectName(QStringLiteral("power1_7"));
        power1_7->setGeometry(QRect(10, 190, 108, 22));
        power1_8 = new QLineEdit(widget_12);
        power1_8->setObjectName(QStringLiteral("power1_8"));
        power1_8->setGeometry(QRect(10, 230, 108, 22));
