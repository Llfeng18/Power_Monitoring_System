...
#define QUEUE_NODE_DATA_LEN   (1*256 )       //单个接收缓冲区大小
...
#define Cmd_L_Empty                               0x00

#define Cmd_Pi_ReadCCOmailaddress                 0x01
#define Cmd_Pi_ReadSTAmailaddress                 0x02
#define Cmd_Pi_Readmeteraddress                   0x03
#define Cmd_Pi_Readmeterdata                      0x04
...
extern QueueBuffer rx_queue_debug;
extern QueueBuffer rx_queue_pi;
extern __IO uint8_t debug_index;



/*信息输出*/
#define QUEUE_DEBUG_ON         debug_index
#define QUEUE_DEBUG_ARRAY_ON		debug_index
...
#define PRINTF_ARRAY(array, num)    do{\
																									 int32_t i;\
																									 uint8_t* a = array;\
																									 if(1)\
																									 {\
