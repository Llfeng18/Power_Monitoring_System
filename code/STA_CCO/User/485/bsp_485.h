...
#define RS485_DEBUG_ON          debug_index
#define RS485_DEBUG_ARRAY_ON    debug_index
#define RS485_DEBUG_FUNC_ON     debug_index
...
#define RS485_DEBUG_SEND(array, num)    do{\
                                         int32_t i;\
                                         uint8_t* a = array;\
                                         if(RS485_DEBUG_ARRAY_ON)\
                                         {\
                                            printf("<<-RS485-DEBUG-SEND->>\r\n");\
                                            for (i = 0; i < (num); i++)\
                                            {\
                                                printf("%02x   ", (a)[i]);\
                                                if ((i + 1 ) %10 == 0)\
