...
extern __IO uint8_t ShowTime;
__IO uint8_t save_data_flash=0;
/*星期，生肖用文字ASCII码*/
...
//		printf("\r\n\r\n RTC configured....");
	...
	else
	{
	  ...
	  /*LSE启动无需设置新时钟*/
		...
		{
		    printf("\r                Power On Reset occurred....\n");
		}
		/*检查是否Reset复位*/
		else if (RCC_GetFlagStatus(RCC_FLAG_PINRST) != RESET)
		{

			printf("\r                External Reset occurred....\n");
		}
...
//	      Time_Display( RTC_GetCounter(),tm,realtime); 		  
//	      TimeDisplay = 0;
//	    }
	  }
}
...
//	      FirstDisplay = 0;
//	  }
		if(tm->tm_min==30&&tm->tm_sec<5){
			save_data_flash=1;
		}
		Automatic_data_acquisition[29]=tm->tm_year/100;
		Automatic_data_acquisition[30]=tm->tm_year%100;
		Automatic_data_acquisition[31]=tm->tm_mon;
		Automatic_data_acquisition[32]=tm->tm_mday;
		
		Automatic_data_acquisition[33]=tm->tm_hour;
		Automatic_data_acquisition[34]=tm->tm_min;
		Automatic_data_acquisition[35]=tm->tm_sec;
		
//		printf(" %d%d年%d月%d日 %0.2d:%0.2d:%0.2d\n",Automatic_data_acquisition[29],Automatic_data_acquisition[30],Automatic_data_acquisition[31],Automatic_data_acquisition[32],Automatic_data_acquisition[33],Automatic_data_acquisition[34],Automatic_data_acquisition[35]);
